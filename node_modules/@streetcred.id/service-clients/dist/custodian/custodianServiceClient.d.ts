...
declare class CustodianServiceClient extends CustodianServiceClientContext {
     ...
     * @param callback The callback
     */
    getAvailableCredentialsForVerification(walletId: string, verificationId: string, callback: msRest.ServiceCallback<Models.VerificationPoliciesContract>): void;
    /**
     * @param walletId
     * @param verificationId
     * @param options The optional parameters
     * @param callback The callback
     */
    getAvailableCredentialsForVerification(walletId: string, verificationId: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.VerificationPoliciesContract>): void;
    /**
     * Healthcheck
     * @summary Healthcheck
     * @param [options] The optional parameters
