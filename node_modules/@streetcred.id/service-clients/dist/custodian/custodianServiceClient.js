...
var CustodianServiceClient = /** @class */ (function (_super) {
    ...
    CustodianServiceClient.prototype.healthcheck = function (options, callback) {
        return this.sendOperationRequest({
            options: options
        }, healthcheckOperationSpec, callback);
    };
...
var submitVerificationOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: {
            serializedName: "verificationPolicyParametersArray",
            type: {
                name: "Sequence",
                element: {
                    type: {
...
var getAvailableCredentialsForVerificationOperationSpec = {
    ...
    responses: {
        200: {
            bodyMapper: Mappers.VerificationPoliciesContract
        },
        401: {},
        403: {},
        default: {}
...
var healthcheckOperationSpec = {
    httpMethod: "GET",
    path: "custodian/v1/health",
    responses: {
        200: {},
        default: {}
    },
