...
`
  ...
  <head>
      ...
      <p id="cert-declaration" class="smaller" style="padding-left: 30px;">This is certify that <span style="color: #3366ff;">Mohammed Said</span> has successfully completed the Bachelor degree of computer engineering</p>
      <h2 id="cert-course" style="padding-left: 30px;">Degree: 2.95</h2>
      <p id="cert-issued" class="smaller" style="padding-left: 30px;"><strong>Issujed on:</strong> {{date}}.</p>
